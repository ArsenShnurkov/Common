namespace Common.Collections.Generic
{
    ...
    /// 
    /// Based on my timings this tree is faster than the recusive BinarySearchTree class. However it is only good on it's own.
    ...
    /// 
    /// So. If you only need a basic BinarySearchTree use the SafeBinarySearchTree.
    /// </summary>
    /// <typeparam name="T">The type that will be stored in the nodes of the tree</typeparam>
    public sealed partial class SafeBinarySearchTree<T> : IBinarySearchTree<T> where T : IComparable<T>
    {
        /// <summary>
        /// Creates a new instance of a Common.Collections.Generic.BinarySearchTree<T>
        /// </summary>
        public SafeBinarySearchTree()
        {
        }
        ...
        /// </summary>
        internal SafeBinaryNode<T> Root { get; set; }
        ...
        internal void Insert(SafeBinaryNode<T> node)
        {
            if (this.Root == null)
            {
                this.Root = node;
        ...
        {
            var node = new SafeBinaryNode<T>(value);
            this.Insert(node);
        }
        ...
        internal void DeleteNode(SafeBinaryNode<T> node, SafeBinaryNode<T> parentNode)
        {
            if (node == null)
        ...
        public IEnumerable<T> InOrderIterator
        {
            get
            {
                ...
                SafeBinaryNode<T> current = this.Root;
                Stack<SafeBinaryNode<T>> parentStack = new Stack<SafeBinaryNode<T>>();
        ...
        public IEnumerable<T> PostOrderIterator
        {
            get
            {
                ...
                SafeBinaryNode<T> previous = null;
                Stack<SafeBinaryNode<T>> nodeStack = new Stack<SafeBinaryNode<T>>();
